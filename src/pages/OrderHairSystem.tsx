...
const choices = {
  systemType: ["Lace", "Skin", "Lace front with skin perimeter"],
  baseSize: ["7 x 9", "7 x 10", "8 x 10", "8 x 11", "Custom size"],
  density: ["80%", "90%", "100% (regular)", "110%", "Custom density"],
  curl: ["Straight", "Body wave", "Loose curl", "Medium curl", "Custom curl"],
};
const emptyForm = {
  barberName: "", barberPhone: "", clientName: "", systemType: "Lace", baseSize: "8 x 10", color: "", length: "", density: "100% (regular)", curl: "Straight", parting: "Freestyle", quantity: "1", shippingSpeed: "Standard", address1: "", address2: "", city: "", state: "", zip: "", notes: "",
};
