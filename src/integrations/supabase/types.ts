  ...
  public: {
    Tables: {
      ...
      aion_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "aion_messages_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "aion_conversations"
            referencedColumns: ["id"]
      ...
      certification_photos: {
        ...
        Relationships: [
          {
            foreignKeyName: "certification_photos_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
      ...
      support_message_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_message_reactions_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "support_conversations"
            referencedColumns: ["id"]
