  ...
  return (
    ...
    >
        ...
        {isManufacturerView ? (
          ...
          <>
            ...
            <ExpandableNavItem icon={BookOpen} label="Courses" collapsed={collapsed} defaultOpen>
              ...
              <SubNavItem to="/courses/business/lesson/setting-up-your-yelp" icon={Briefcase} label="Setting Up your yelp" />
      ...
      <div className="p-4 border-t border-sidebar-border space-y-2 relative z-10">
        {/* Admin Mode Toggle - hide when in manufacturer view */}
        {userIsAdmin && !isManufacturerView && !collapsed && (
