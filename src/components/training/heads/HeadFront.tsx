...
interface HeadFrontProps {
  eyebrowsLifted: boolean;
  showGuide: boolean;
  className?: string;
}

export const HeadFront = forwardRef<SVGSVGElement, HeadFrontProps & React.SVGProps<SVGSVGElement>>(
  ({ eyebrowsLifted, showGuide, className, ...props }, ref) => {
    return (
      ...
      >
        ...
        <defs>
          <radialGradient id="skinGradientFront" cx="50%" cy="40%" r="55%">
            <stop offset="0%" stopColor="#e8c49a" />
            <stop offset="50%" stopColor="#d4a574" />
            <stop offset="100%" stopColor="#c9956a" />
          </radialGradient>
          <radialGradient id="baldGradientFront" cx="50%" cy="40%" r="50%">
            <stop offset="0%" stopColor="#e8c49a" />
        ...
        <path 
          d={`
            ...
            Q 82 170, 85 130
          `}
          fill="url(#skinGradientFront)"
        />

        {/* Bald top */}
        <ellipse cx="150" cy="70" rx="50" ry="30" fill="url(#baldGradientFront)" />
...
HeadFront.displayName = 'HeadFront';
