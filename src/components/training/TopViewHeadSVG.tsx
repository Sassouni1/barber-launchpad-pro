  ...
  return (
    <g>
      ...
      {thinningPattern === "frontal" ? (
        <>
          {/* M-shaped hairline: hair starts at head edges, front edge recedes at temples, exposing scalp at corners */}
          <path
            d="
              M 50,90
              C 50,120 50,160 52,200
              C 58,245 95,275 150,280
              C 205,275 242,245 248,200
              C 250,160 250,120 250,90
              C 240,80 220,75 200,85
              Q 180,100 165,110
              Q 155,90 150,72
              Q 145,90 135,110
              Q 120,100 100,85
