...
=== end photography instructions ===`;
    ...
    const ethnicityMap: Record<string, string> = {
      ...
      white: [
        'Northern European white man (Scandinavian/British/German): very fair pale skin, blond or light-brown hair, blue or green eyes, clean-shaven or light stubble. MUST be visibly white European, NOT tanned, NOT auburn/red-haired.',
        'Mediterranean white man (Italian/Greek/Spanish): light-olive skin, dark-brown or near-black hair, deep brown eyes, full dark beard or heavy stubble. MUST be visibly white European of southern descent — NOT racially ambiguous.',
        'Slavic/Eastern European white man (Polish/Russian/Ukrainian): fair skin, ash-brown or dark-blond hair, grey or hazel eyes, sharp angular cheekbones, clean-shaven or short beard. MUST be visibly white European — NOT auburn/red, NOT olive-skinned.',
      ][layoutIndex % 3],
