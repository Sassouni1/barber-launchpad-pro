...
- If the entire note is a likely person's first name or short professional name with no other context, treat it as a possible personal-brand direction before treating it as an unrelated dictionary meaning. Do not default to alcohol, food, place, or product associations. In that case, include strong, natural personal-brand ideas in the first 8, such as Hair by [name], Fades by [name], Cuts by [name], or similarly real alternatives. Keep them editable in the client; do not assume a legal name is the preferred form. Still include varied standalone directions in the rest of the first 8 where helpful, but do not generate generic "Name + Studio/Lounge/Collective" permutations.
